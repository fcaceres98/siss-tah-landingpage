...
export default function Home() {
    ...
    useEffect(() => {
        ...
        fetchTempInvoice();
    }, [apiUrl, invoiceId_temp, reservationId_temp, responseData]);
                ...
                <Card className="flex flex-col w-full max-w-5xl mx-auto border p-4 bg-background">
                    ...
                    <CardContent className="grid grid-cols-1 gap-4">
                        ...
                        <div className="col-span-1">
                            ...
                            <div className="flex-1">
                                <ResponsePage invoice={Number(invoiceId_temp)} reservation={Number(reservationId_temp)} response={responseData ?? ""} />
                            </div>
                            <div className="flex-1">
                                <InvoicePage invoice={Number(invoiceId_temp)} reservation={Number(reservationId_temp)} response={responseData ?? ""} />
                            </div>
                        </div>
                        )}
                    </CardContent>
